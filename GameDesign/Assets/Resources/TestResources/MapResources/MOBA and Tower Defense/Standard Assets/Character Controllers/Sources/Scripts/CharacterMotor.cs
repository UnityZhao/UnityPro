...
public class MouseLook : MonoBehaviour
{
    ...
    internal class CharacterMotorMovement
    {
        // The maximum horizontal speed when moving
        internal float maxForwardSpeed = 10.0f;
        internal float maxSidewaysSpeed = 10.0f;
    ...
    internal CharacterMotorMovement movement;
    ...
    internal class CharacterMotorJumping
    {
        ...
        internal float lastButtonDownTime = -100f;

        internal Vector3 jumpDir = Vector3.up;
    }

    CharacterMotorJumping jumping;

    internal class CharacterMotorMovingPlatform
    {
        internal bool enabled = true;
    ...
    CharacterMotorMovingPlatform movingPlatform;

    internal class CharacterMotorSliding
    {
        // Does the character slide on too steep surfaces?
        internal bool enabled = true;

        // How fast does the character slide on steep surfaces?
        internal float slidingSpeed = 15f;
